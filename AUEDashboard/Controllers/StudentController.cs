...
namespace AUEDashboard.UI.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(IUserRepository userRepository, IAssignmentRepository assignmentRepository)
        {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var assessments = await _assignmentRepository.GetAllAssessmentDetailsByStudentd(studentId);
